    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 text-white">
      ...
      <nav className="bg-gray-900 shadow-sm border-b border-gray-700 text-white">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-3xl font-bold text-white">ADFS OIDC Dashboard</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto p-8">
        <h1 className="text-xl font-bold mb-2 text-white">
          OIDC based authentication is successful
        </h1>
        <p className="text-gray-300 mb-8">
          You are authenticated directly by On-Premise ADFS (using OIDC through Entra)
        </p>
